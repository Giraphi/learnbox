...
type AddVocabularyDrawerProps = {
  isOpen: boolean;
  onClose: () => void;
};

export default function AddVocabularyDrawer({
  isOpen,
  onClose,
}: AddVocabularyDrawerProps) {
  ...
  return (
    <Drawer.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed inset-x-0 bottom-0 flex h-[80vh] flex-col rounded-t-2xl bg-neutral-950">
          ...
          <div className="overflow-y-auto p-6">
            ...
            <Drawer.Description className="sr-only">
              Enter a German word to translate and add to your vocabulary box.
            </Drawer.Description>
